...
This delimiter is used to split the input text into several text pieces echo of which will be performed as input item of each iteration.`,
      ...
      schedule: {
        ...
        namePlaceholder: 'Please enter a schedule name',
        frequency: 'Frequency',
        runCount: 'Run count',
        status: 'Status',
        for: 'For',
        ...
        daysOfWeekPlaceholder: 'Please select days of the week',
        ...
        at: 'at',
        executeDateRequired: 'Please select an execute date',
        executeDatePlaceholder: 'Please select an execute date',
